...
constexpr float GEAR_RATIO = 9.68;
constexpr int COUNTS_PER_MOTOR_REV = 48; // 12 CPR * 4
constexpr float WHEEL_DIAMETER_METERS = 0.070; // 70mm wheels
constexpr float DIST_PER_COUNT = (PI * WHEEL_DIAMETER_METERS) / (COUNTS_PER_MOTOR_REV * GEAR_RATIO); // where is PI defined
